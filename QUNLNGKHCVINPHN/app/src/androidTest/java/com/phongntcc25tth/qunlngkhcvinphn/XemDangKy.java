...
import java.util.ArrayList;
    ...
    public class sv_XemDangKy extends AppCompatActivity {
        ListView lvDS;
        DBHelper db;
        ...
        protected void onCreate(Bundle b) {
            super.onCreate(b);
            setContentView(R.layout.sv_xem_dangky);
            ...
            c.close();
            if (ds.isEmpty()) Toast.makeText(this, "Chưa đăng ký học phần nào!", Toast.LENGTH_SHORT).show();

...
import android.database.sqlite.SQLiteOpenHelper;
    ...
    public class DBHelper extends SQLiteOpenHelper {
        ...
        public static final String COL_TENTK = "TenTK";
        ...
        public static final String COL_VAITRO = "VaiTro"; // QTV / SinhVien
        ...
        public static final String COL_TRANGTHAI = "TrangThai"; // ChoDuyet / DaDuyet / TuChoi
        ...
        // === LẤY TẤT CẢ PHIẾU CHỜ DUYỆT ===
        public Cursor layDSChờDuyet() {
            return getReadableDatabase().rawQuery(
